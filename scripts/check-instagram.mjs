...
const server=createServer(async(req,res)=>{
  ...
  try{
    ...
    if(!['instagram.html','instagram.js','instagram.css','feed.css','review-gallery.js','feed.html','feed.js'].includes(file)){res.writeHead(404).end();return;}
