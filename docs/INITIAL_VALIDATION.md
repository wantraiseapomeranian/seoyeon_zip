...
> 공개 전환 이전 README를 보관한 문서입니다. 계정 수, 운영 설정, 수집 간격 등은 당시 기록이며 현재 운영 안내가 아닙니다. 현재 설명은 [README](../README.md), 실제 검증 이력은 [VALIDATION](VALIDATION.md)을 참고하세요.
...
시범 활성화 기록은 [후속 계획](superpowers/plans/2026-09-09-collection-followup.md)과 VALIDATION.md를 따릅니다. 검증용 cursor를 운영 완료 경계로 이관하지 않았습니다. 날짜 제한 없이 최대 20페이지 내에서 과거 자료를 보완하며 완전성을 보장하지 않습니다.
