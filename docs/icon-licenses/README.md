...
The `icons=phosphor|lucide|tabler` query parameter enables the comparison. The chosen zine layout and mist background remain unchanged. The user selected the first option, Phosphor Regular, on 2026-09-09. Lucide and Tabler remain comparison references.
